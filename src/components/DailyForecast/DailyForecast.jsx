                                    ...
                                    >
                                        ...
                                        <div className={styles.descriptionWrap}>
                                            <img 
                                                ...
                                                src={utils.getWeatherIconSrc(dailyForecast[key][(dailyForecast[key].length / 2).toFixed(0)].weather[0].icon)} 
                                                alt="" 
                                            />
                                            <span className={styles.description}>
                                                {dailyForecast[key][(dailyForecast[key].length / 2).toFixed(0)].weather[0].description}
                                            </span>
                                        </div>
                                    </div>
                                }
